...
use omnity_indexer_sync::{universal, with_agent};
...
mod management_canister {
    ...
    use omnity_indexer_sync::{get_effective_canister_id, with_universal_canister};
    ...
    mod create_canister {
        ...
        use omnity_indexer_sync::get_effective_canister_id;
        use std::str::FromStr;
...
mod simple_calls {
    use crate::universal::payload;
    use ic_agent::{
        agent::{RejectCode, RejectResponse},
        AgentError,
    };
    use omnity_indexer_sync::with_universal_canister;
...
mod extras {
    ...
    use omnity_indexer_sync::get_effective_canister_id;
    use omnity_indexer_sync::with_agent;
