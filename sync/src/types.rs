...
/// for execution chain, the chain id spec is: type-chain_name,eg: EVM-Base,Cosmos-Gaia,
/// Substrate-Xxx
...
/// token id spec is setllmentchain_name-potocol-symbol, eg:
/// Bitcoin-RUNES-WHAT•ABOUT•THIS•RUNE,Ethereurm-ERC20-OCT,ICP-ICRC2-XO metadata stores extended
/// information，for runes protocol token, it stores the runes id
...
/// chain id spec:
/// for settlement chain, the chain id is: Bitcoin, Ethereum,or ICP
/// for execution chain, the chain id spec is: type-chain_name,eg:
/// EVM-Base,Cosmos-Gaia,Substrate-Xxx
#[derive(CandidType, Deserialize, Serialize, Clone, Debug, PartialEq, Eq, Hash)]
pub struct Chain {
	pub chain_id: ChainId,
	pub canister_id: String,
...
// token id spec is setllmentchain_name-potocol-symbol, eg: Ethereurm-ERC20-OCT ,
// Bitcoin-RUNES-WHAT•ABOUT•THIS•RUNE
